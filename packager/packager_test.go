...
func TestEncodedSignedString(t *testing.T) {
	xmlreq := GetTestData()
	signed, err := packager.EncodedSignedString(xmlreq, "/go/src/github.com/RobotsAndPencils/go-saml/certs/default.key")
	assert.NoError(t, err)
...
func TestCompressedEncodedSignedStringFromKey(t *testing.T) {
	cert, err := ioutil.ReadFile("/go/src/github.com/RobotsAndPencils/go-saml/certs/default.key")
	assert.NoError(t, err)
...
func TestCompressedEncodedSignedString(t *testing.T) {
	xmlreq := GetTestData()
	signed, err := packager.CompressedEncodedSignedString(xmlreq, "/go/src/github.com/RobotsAndPencils/go-saml/certs/default.key")
	assert.NoError(t, err)
